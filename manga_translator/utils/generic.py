...
# Allow overriding the base path (and model download dir) via env var
_env_models = os.environ.get('MIT_MODELS_DIR')
if _env_models:
    # MIT_MODELS_DIR points to <base>/models, so BASE_PATH is one level up
    BASE_PATH = os.path.dirname(_env_models)
else:
